...
class Disk():
    ...
    def plot_rho_slice(self, phi = 0, thickness = f_z, fine = 100, maxheight = None, logarithmic_scale=False, note = "", show = True, fig = None):
        ...
        if self.density.ndim == 2:
            ...
            if logarithmic_scale: 
                import matplotlib.colors
                ap = ax.pcolormesh(x_mesh, y_mesh, density.T, norm=matplotlib.colors.LogNorm(), cmap = "hot", mi)
...
def main():
    ...
    for iteration in range(3):
        ...
        disk.plot_density_slice(show = False, note = f"Iteration {iteration}", logarithmic_scale=True)
